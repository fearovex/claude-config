...
## ADDED in skill-format-types (2026-03-01)
...
declared format type (see `docs/format-types.md`). Missing the required section for
...
*(Modified in: 2026-03-01 by change "skill-format-types")*
