...
description: >
  Core catalog de 8 anti-patrones críticos de Elixir/Phoenix: error handling,
  separación de concerns, Ecto queries y testing.
  Trigger: Durante code review, refactoring, o al escribir código Phoenix/Ecto.
license: Apache-2.0
metadata:
