...
4. IF character count <= budget:
   → Add INFO finding: `"CLAUDE.md budget OK: [N]/[budget] chars."`

Findings are appended to `audit-report.md` in a `## Budget Compliance` section. They do NOT affect any audit score dimension.
